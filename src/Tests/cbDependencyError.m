function [dependencyMatrix, dependencyMatrix2] = cbDependencyError(maxP, maxScale, n)
    ...
    dependencyMatrix = zeros(maxP, maxScale); % First dependency matrix
    dependencyMatrix2 = zeros(maxP, maxScale); % Second dependency matrix for @normalSolve and @normalDecomposition
    ...
    for p = 1:maxP
        for scale = 1:maxScale
            ...
            % Decomposition for the first method
            ...
            % Decomposition for the second method
